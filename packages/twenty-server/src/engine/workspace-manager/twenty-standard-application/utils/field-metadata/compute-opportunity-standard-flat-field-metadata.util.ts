...
>): Record<AllStandardObjectFieldName<'opportunity'>, FlatFieldMetadata> => ({
  ...
  pipeline: createStandardRelationFieldFlatMetadata({
    ...
    context: {
      ...
      description: i18nLabel(msg`The pipeline this opportunity belongs to`),
      icon: 'IconFilter',
      isNullable: true,
  ...
  pipelineStage: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      ...
      settings: {
        relationType: RelationType.MANY_TO_ONE,
        onDelete: RelationOnDeleteAction.SET_NULL,
        joinColumnName: 'pipelineStageId',
      },
    },
    standardObjectMetadataRelatedEntityIds,
    dependencyFlatEntityMaps,
  ...
  pipelineStageId: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'pipelineStageId',
      type: FieldMetadataType.UUID,
      label: i18nLabel(msg`Pipeline stage id`),
      description: i18nLabel(msg`Pipeline stage id foreign key`),
      icon: 'IconProgressCheck',
      isSystem: true,
      isNullable: true,
    },
